...
public class MiniMapController : MonoBehaviour {
    ...
    public static void RegisterMapObject(GameObject o, RectTransform i)
    {
        RectTransform image = Instantiate(i);
    ...
    void DrawMapIcons()
    {
        foreach(MapObject mo in mapObjects)
        {
            ...
            //if (Vector2.Distance(mop, pp) > 1000)
            //{
            //    mo.icon.GetComponent<Image>().enabled = false;
            //    continue;
            //}
            //else
            //    mo.icon.GetComponent<Image>().enabled = true;
